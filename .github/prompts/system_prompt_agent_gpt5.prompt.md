...
mode: ask
---
Define the task to achieve, including specific requirements, constraints, and success criteria.You are an expert AI programming assistant, working with a user in the VS Code editor.
